...
// Soak Testing
// Goal: Test the system's stability and performance over a prolonged period under constant load.
...
export const options = {
    stages: [
        { duration: '2h', target: 100 },  // ramp up to 100 users
        { duration: '3h', target: 100 },  // stay at 100 users for 3 hours
        { duration: '2h', target: 0 },    // ramp down to 0 users
    ],
};
